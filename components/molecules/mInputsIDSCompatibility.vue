<template>
    <div class="o-form-item__group">
        <div class="o-form-item__group-items" v-if="IDScompatibilityArray && IDScompatibilityArray.length > 0">
        ...
        <div :class="'o-form-item__buttons' + ((IDScompatibilityArray && IDScompatibilityArray.length > 0) ? 'mt-1' : '')">
