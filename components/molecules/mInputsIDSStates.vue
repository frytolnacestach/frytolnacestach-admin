<template>
    <div class="o-form-item__group">
        <div class="o-form-item__group-items" v-if="IDSstatesArray && IDSstatesArray.length > 0">
        ...
        <div :class="'o-form-item__buttons' + ((IDSstatesArray && IDSstatesArray.length > 0) ? 'mt-1' : '')">
