<template>
    <div class="o-form-item__group">
        <div class="o-form-item__group-items" v-if="tripPricesArray && tripPricesArray.length > 0">
        ...
        <div :class="'o-form-item__buttons' + ((tripPricesArray && tripPricesArray.length > 0) ? 'mt-1' : '')">
