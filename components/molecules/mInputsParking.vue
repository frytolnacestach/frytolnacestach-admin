<template>
    <div class="o-form-item__group">
        <div class="o-form-item__group-items" v-if="parkingArray && parkingArray.length > 0">
            <div class="o-form-item__group-item" v-for="(item, index) in parkingArray" :key="index">
                ...
                <div class="o-form-item__group-inputs">
                    ...
                    <div class="o-form-item__group-input">
                        ...
                        <input class="a-input -json" type="text" v-model="item.price" />
                    </div>
                    <div class="o-form-item__group-input">
        ...
        <div :class="'o-form-item__buttons' + ((parkingArray && parkingArray.length > 0) ? 'mt-1' : '')">
