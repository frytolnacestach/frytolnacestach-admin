<template>
    <div class="o-form-item__group">
        <div class="o-form-item__group-items" v-if="travelsArray && travelsArray.length > 0">
            <div class="o-form-item__group-item" v-for="(item, index) in travelsArray" :key="index">
                ...
                <div class="o-form-item__group-inputs">
                    <div class="o-form-item__group-input">
                        ...
                        <input class="a-input -json" type="text" v-model="item.icon" />
                    </div>
                    <div class="o-form-item__group-input">
        ...
        <div :class="'o-form-item__buttons' + ((travelsArray && travelsArray.length > 0) ? 'mt-1' : '')">
