<template>
    <div class="o-form-item__group">
        <div class="o-form-item__group-items" v-if="peopleReligionArray && peopleReligionArray.length > 0">
        ...
        <div :class="'o-form-item__buttons' + ((peopleReligionArray && peopleReligionArray.length > 0) ? 'mt-1' : '')">
...
<script>
    ...
    export default defineComponent({
        name: 'MoleculesmInputsPeopleReligionComponent',
