<template>
    <div class="o-form-item__group">
        <div class="o-form-item__group-items" v-if="linksPlaceArray && linksPlaceArray.length > 0">
        ...
        <div :class="'o-form-item__buttons' + ((linksPlaceArray && linksPlaceArray.length > 0) ? 'mt-1' : '')">
