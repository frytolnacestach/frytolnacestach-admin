<template>
    <div class="o-form-item__group">
        <div class="o-form-item__group-items" v-if="ingredientsArray && ingredientsArray.length > 0">
            <div class="o-form-item__group-item" v-for="(item, index) in ingredientsArray" :key="index">
                ...
                <div class="o-form-item__group-inputs">
                    ...
                    <div class="o-form-item__group-input">
                        ...
                        <input class="a-input -json" type="text" v-model="item.unit" />
                    </div>
                </div>
            </div>
        </div>
        <div :class="'o-form-item__buttons' + ((ingredientsArray && ingredientsArray.length > 0) ? 'mt-1' : '')">
