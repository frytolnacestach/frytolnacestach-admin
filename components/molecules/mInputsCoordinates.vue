<template>
    <div class="o-form-item__group">
        <div class="o-form-item__group-items" v-if="coordinatesArray && coordinatesArray.length > 0">
        ...
        <div :class="'o-form-item__buttons' + ((coordinatesArray && coordinatesArray.length > 0) ? 'mt-1' : '')">
