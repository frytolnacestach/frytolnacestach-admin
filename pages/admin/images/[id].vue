                                ...
                                <div class="o-image-version__outer">
                                    <div class="o-image-version__inner">
                                        <table class="o-image-version__table">
                                            ...
                                            <tr class="o-image-version__content" v-for="(item, index) in sizes" :key="item.prefix">
    ...
    export default defineComponent({
        ...
        setup() {
            const sizes = [
                ...
                { width: 40, height: 40, prefix: "s-", suffix: "-1x" },
                { width: 50, height: 50, prefix: "s-", suffix: "-1x" },
                { width: 70, height: 70, prefix: "s-", suffix: "-1x" },
                { width: 166, height: 166, prefix: "s-", suffix: "-1x" },
                { width: 172, height: 172, prefix: "s-", suffix: "-1x" },
                { width: 186, height: 186, prefix: "s-", suffix: "-1x" },
                { width: 210, height: 210, prefix: "s-", suffix: "-1x" },
                { width: 224, height: 224, prefix: "s-", suffix: "-1x" },
                { width: 230, height: 230, prefix: "s-", suffix: "-1x" },
                { width: 240, height: 240, prefix: "s-", suffix: "-1x" },
                { width: 256, height: 256, prefix: "s-", suffix: "-1x" },
                { width: 274, height: 274, prefix: "s-", suffix: "-1x" },
                { width: 306, height: 306, prefix: "s-", suffix: "-1x" },
                { width: 320, height: 320, prefix: "s-", suffix: "-1x" },
                { width: 344, height: 344, prefix: "s-", suffix: "-1x" },
                { width: 360, height: 360, prefix: "s-", suffix: "-1x" },
                { width: 370, height: 370, prefix: "s-", suffix: "-1x" },
                { width: 430, height: 430, prefix: "s-", suffix: "-1x" },
                { width: 556, height: 556, prefix: "s-", suffix: "-1x" },
                { width: 738, height: 738, prefix: "s-", suffix: "-1x" },
                { width: 962, height: 962, prefix: "s-", suffix: "-1x" },
                ...
                { width: 40 * 2, height: 40 * 2, prefix: "s-", suffix: "-2x" },
                { width: 50 * 2, height: 50 * 2, prefix: "s-", suffix: "-2x" },
                { width: 70 * 2, height: 70 * 2, prefix: "s-", suffix: "-2x" },
                { width: 166 * 2, height: 166 * 2, prefix: "s-", suffix: "-2x" },
                { width: 172 * 2, height: 172 * 2, prefix: "s-", suffix: "-2x" },
                { width: 186 * 2, height: 186 * 2, prefix: "s-", suffix: "-2x" },
                { width: 210 * 2, height: 210 * 2, prefix: "s-", suffix: "-2x" },
                { width: 224 * 2, height: 224 * 2, prefix: "s-", suffix: "-2x" },
                { width: 230 * 2, height: 230 * 2, prefix: "s-", suffix: "-2x" },
                { width: 240 * 2, height: 240 * 2, prefix: "s-", suffix: "-2x" },
                { width: 256 * 2, height: 256 * 2, prefix: "s-", suffix: "-2x" },
                { width: 274 * 2, height: 274 * 2, prefix: "s-", suffix: "-2x" },
                { width: 306 * 2, height: 306 * 2, prefix: "s-", suffix: "-2x" },
                { width: 320 * 2, height: 320 * 2, prefix: "s-", suffix: "-2x" },
                { width: 344 * 2, height: 344 * 2, prefix: "s-", suffix: "-2x" },
                { width: 360 * 2, height: 360 * 2, prefix: "s-", suffix: "-2x" },
                { width: 370 * 2, height: 370 * 2, prefix: "s-", suffix: "-2x" },
