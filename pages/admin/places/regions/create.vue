                                ...
                                <form class="o-form-create__form" @submit.prevent="createForm">
                                    <div class="o-form-create__items">
                                        ...
                                        <div class="o-form-create__item">
                                            ...
                                            <div class="o-form-create__group">
                                                <div class="o-form-create__group-items">
                                                    <div class="o-form-create__group-item" v-for="(item, index) in placesRegionSeoTagsArray" :key="index">
                                        ...
                                        <div class="o-form-create__item">
                                            ...
                                            <div class="o-form-create__group">
                                                <div class="o-form-create__group-items">
                                                    <div class="o-form-create__group-item" v-for="(item, index) in placesRegionInformationAuthorArray" :key="index">
                                                        <div class="m-button-remove">
                                        ...
                                        <div class="o-form-create__item">
                                            ...
                                            <div class="o-form-create__group">
                                                <div class="o-form-create__group-items">
                                                    <div class="o-form-create__group-item" v-for="(item, index) in placesRegionCoordinatesArray" :key="index">
                                                        <div class="m-button-remove">
                                        ...
                                        <div class="o-form-create__item">
                                            ...
                                            <div class="o-form-create__group">
                                                <div class="o-form-create__group-items">
                                                    <div class="o-form-create__group-item" v-for="(item, index) in placesRegionZoomArray" :key="index">
                                                        <div class="m-button-remove">
                                        ...
                                        <div class="o-form-create__item">
                                            ...
                                            <div class="o-form-create__group">
                                                <div class="o-form-create__group-items">
                                                    <div class="o-form-create__group-item" v-for="(item, index) in placesRegionAffiliateArray" :key="index">
                                                        <div class="m-button-remove">
