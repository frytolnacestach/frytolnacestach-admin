    ...
    <NuxtLayout name="admin">
        <main class="t-main -pt-menu">
            ...
            <section class="t-section my-2">
                <div class="t-section__inner">
                    <oSearch type="region" :page=1 :items=100 @search-result="handleSearch" />
                </div>
            </section>
            <!-- SECTION - Search END -->
            ...
            <section class="t-section mt-2 mb-8">
                <div class="t-section__inner">
                    <oPagination type="region" :page=page :itemsPerPage=itemsPerPage @select-page="handlePagination" />
                </div>
            </section>
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const load = async () => {
                fetch(`${runTimeConfig.public.baseURL}/places-regions?admin=true&page=${page.value}&items=${itemsPerPage}`, {
                    method: 'GET'
                })
                .then(res => res.json())
                .then(data => {
